...
export default class Menu {
    ...
    constructor(scene, world, camera, renderer) {
        ...
        //this.$navItems = container.querySelectorAll('.mainNav a')
    ...
    setup(font) {
        this.words = []
        this.margin = 6
        this.offset = itemLength * this.margin * 0.5
        ...
        Array.from(this.navItems).reverse().forEach((item, i) => {
            ...
            Array.from(innerText).forEach((letter, j) => {
                ...
                // Cannon.js
                mesh.initPosition = new C.Vec3(words.len * 2, (itemLength - 1 - i) * this.margin - this.offset, 0)
...
const fontURL = './react-client/dist/fonts/helvetiker_bold.typeface.json'
const colors = [
    {

...
function Text({ children, size = 1, left, right, top, bottom, color = "white", opacity = 1, height = 0.01, layers = 0, font = "./react-client/public/MOONGET_Heavy.json", ...props }) {
  const data = useLoader(FontLoader, "./react-client/public/MOONGET_Heavy.json")
